	...
	<el-dialog
	  ...
	  <el-form :model="mfsupplierForm" :rules="rules" ref="mfsupplierForm" label-width="120px">
	  	<el-form-item label="企业名称" prop="job_number">
		    <el-input v-model="mfsupplierForm.job_number" placeholder="请输入企业名称"></el-input>
		  </el-form-item>
		  ...
		  <el-form-item label="用户角色" prop="group_ids">
		    <el-select v-model="mfsupplierForm.group_ids" multiple clearable filterable placeholder="下拉选择或搜索输入" class="w-100">
			    <el-option
